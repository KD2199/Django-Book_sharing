...
Idata = Available_Books.objects.create(BookName=str(BookName), Edition=str(Edition), AuthorName=str(
    ...
    if Total_books.objects.filter(user=(Available_Books.objects.filter(Ownername=Ownername))).exists():
    
        temp = Total_books.objects.filter(User=Ownername).update(Number_Of_Books_Donate=str((Available_Books.objects.filter(Ownername=Ownername).count())))

    else:
        temp = Total_books.objects.create(User=str(Ownername), Number_Of_Books_Donate=str((Available_Books.objects.filter(Ownername=Ownername).count())))
